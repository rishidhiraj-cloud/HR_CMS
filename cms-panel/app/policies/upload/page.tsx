...
export default function UploadDocumentPage() {
  ...
  return (
    <AppLayout title="Upload Policy Document">
        ...
        {state === 'done' && result ? (
          ...
          >
            ...
            <p className="text-sm mt-2" style={{ color: '#99f6e4' }}>
              {result.chunks} text chunks created and embedded. Employees can now ask questions about this policy.
            </p>
            <div className="mt-6 flex gap-3 justify-center">
              <button
                onClick={() => { setFile(null); setName(''); setState('idle'); setResult(null); if (inputRef.current) inputRef.current.value = '' }}
